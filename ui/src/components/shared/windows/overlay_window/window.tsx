...
import {
  boundElementSize,
  calculateCanvasResizeWindowPosition,
...
import { useWindowNode } from '../manager/use_window_hook';
import { CloseButton, OverlayBody, OverlayHeader, OverlayWrapper } from './components';
import { ResizeButtons } from './resize_buttons';
