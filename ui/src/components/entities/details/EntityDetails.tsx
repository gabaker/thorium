...
// Page context
const EntityDetailsContext = createContext<EntityDetailsContextType | undefined>(undefined);
...
const EntityDetails: React.FC<EntityDetailsProps> = ({ getEntityDetails, blank, metadata, icon }) => {
