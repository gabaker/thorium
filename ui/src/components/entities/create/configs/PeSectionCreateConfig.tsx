    ...
    <>
      ...
      <Row>
        ...
        <InfoValue>
          ...
          <NumberInput value={meta.raw_size ?? null} onChange={(v) => updatePendingMeta('raw_size', v ?? undefined)} min={0} required={false} />
        </InfoValue>
      </Row>
      <hr className="my-3" />
      <Row>
        ...
        <InfoValue>
          <NumberInput value={meta.virtual_size ?? null} onChange={(v) => updatePendingMeta('virtual_size', v ?? undefined)} min={0} required={false} />
        </InfoValue>
      </Row>
      <hr className="my-3" />
      <Row>
        ...
        <InfoValue>
          <NumberInput value={meta.entropy ?? null} onChange={(v) => updatePendingMeta('entropy', v ?? undefined)} min={0} step={0.01} required={false} />
        </InfoValue>
      </Row>
    </>
  );
