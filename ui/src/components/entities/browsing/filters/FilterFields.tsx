...
// project imports
import { decodeParamsToFilters, DEFAULT_HIDE_TAG_KEYS, encodeFiltersToParams } from './params';
import FilterGroups from './FilterGroups';
import FilterTagsField from './FilterTagsField';
import FilterTagDisplayKeys from './FilterTagDisplayKeys';
...
import { FilterTypes, Filters } from '@models/search';
...
const FilterFields: React.FC<FilterWindowProps> = ({ disabled, onChange, groups, exclude, show }) => {
