...
import {
  CompiledFunction,
  CompiledFunctionMetaFields,
  DecompiledFunction,
  DecompiledFunctionMetaFields,
} from '@models/entities/functions';
...
function appendIncidentMetaUpdates(form: FormData, meta: IncidentMetaFields, pending: IncidentMetaFields): void {
  ...
  appendStringListDiff(form, 'metadata[add_mission_teams][]', 'metadata[remove_mission_teams][]', meta.mission_teams, pending.mission_teams);
