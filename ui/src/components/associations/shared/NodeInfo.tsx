...
// project imports
import EntitySummary, { FilteredNodeTags, SummaryVariant } from '@components/shared/info/EntitySummary';
import { treeNodeToInfo } from '@components/shared/info/info';
import { TreeNode } from '@models/trees';

// re-exported for backwards compatibility (treeHelpers imports it from here)
export { FilteredNodeTags };
