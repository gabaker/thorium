      ...
      if (entity?.kind == 'Device') {
        ...
        return (
          <>
            ...
            <Link to={`/file/${entity.metadata.FileSystem.sha256}/`} target={'_blank'}>
              {entity.metadata.FileSystem.sha256}
            </Link>
            <hr />
        ...
        return (
          <>
            <Subtitle className="mt-2">SHA256</Subtitle>
            <Link to={`/file/${entity.metadata.Folder.all_sha256}/`} target={'_blank'}>
              {entity.metadata.Folder.all_sha256}
            </Link>
          </>
        );
      }
