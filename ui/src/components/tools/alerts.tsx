 ...
 *
 * When the result isn't json, the raw string is normalized for display (escaped `\n` sequences
 * turned into real newlines, and every double-quote character removed); non-strings yield an empty
 * string.
...
export { getAlerts, formatResultBody };
