...
export interface TextDiffProps {
  ...
  method?: DiffMethod;
  /** Side-by-side (default) vs unified. */
  splitView?: boolean;
  oldTitle?: string;
  newTitle?: string;
}
 ...
 */
const TextDiff: React.FC<TextDiffProps> = ({ oldValue, newValue, method = DiffMethod.LINES, splitView = true, oldTitle, newTitle }) => {
  const theme = typeof document !== 'undefined' ? document.documentElement.getAttribute('theme') : null;
