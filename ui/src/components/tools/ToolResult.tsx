          ...
          <ClipViewport>
            ...
            >
              <div ref={bodyContentRef}>
                ...
                {activeTab === ToolResultTabKey.Files && <FilesTab result={result} sha256={sha256} tool={tool} type={type} />}
                ...
                {activeTab === ToolResultTabKey.Entities && <EntitiesTab result={result} sha256={sha256} tool={tool} type={type} />}
              </div>
            </ScrollArea>
